    ...
    <div className="bg-white dark:bg-gray-900">
        <div className="flex justify-center h-screen">
            ...
            { !emailSent ? 
              ...
              <div className="flex-1">
                <div className="text-center">
                  <h2 className="text-4xl font-bold text-center text-gray-700 dark:text-white">Check your email</h2>
                  <p className="mt-3 text-gray-500 dark:text-gray-300">Instruction for password reset has been sent.</p>
                </div>
                <div className="mt-8">
                  <p className="mt-6 text-sm text-center text-gray-400 cursor-pointer">Remembered your password? <span onClick={toLogin} className="login-redirect">Login</span>.</p>
                </div>
